...
- [ ] `brand/book/voice.md` has six sections (headlines, subheads, paragraphs, CTAs, eyebrows, microcopy), each with ≥5 specimens and ≥5 anti-specimens
...
- [ ] `brand/book/mission.md` covers: one-sentence definition, three audiences, what Qortex stands against, the tagline + origin
- [ ] `brand/book/do-and-dont.md` has 12–18 do/don't pairs, each pair concrete and actionable (no vague adjectives)
- [ ] JP-specific voice moves are called out in the relevant sections of voice.md
- [ ] `brand/README.md` reading order updated to reflect the complete brand book
